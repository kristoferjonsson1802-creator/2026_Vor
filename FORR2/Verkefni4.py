...
button4=Button(frame1, padx=16, bd=8, fg='Black', text='/', command=deila)
...
button16=Button(frame4, padx=16, bd=8, fg='Black', text='+', command=plus)
